...
| `qc-flow/references/run-file-template.md` | Canonical run-artifact template, including `Delegation State` plus blocking research / plan-check / goal-audit checkpoint sections |
| `qc-flow/references/project-roadmap-template.md` | Project-level roadmap template for milestones, active runs, and cross-run dependencies |
| `qc-flow/references/backlog-template.md` | Backlog template for parking lot, deferred decisions, and future seeds |
