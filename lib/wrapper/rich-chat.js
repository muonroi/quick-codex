...
function OutputPane({ response, busy, outputSource = "final", mode = "short", scrollOffset = 0, viewportLines = 12, height = null, metaWidth = 42 }) {
  ...
  return h(
    ...
    h(
      ...
      view === "timeline"
        ...
        : h(OutputPane, { response: lastResponse, busy, outputSource, mode: resultMode, scrollOffset: resultScroll, viewportLines, height: mainHeight, metaWidth: 42 }),
