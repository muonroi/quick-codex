...
function OutputPane({ response, busy, mode = "short", scrollOffset = 0, viewportLines = 12, height = null, metaWidth = 42 }) {
  ...
  return h(
    ...
    h(
      ...
      view === "timeline"
        ...
        : h(OutputPane, { response: lastResponse, busy, mode: resultMode, scrollOffset: resultScroll, viewportLines, height: mainHeight, metaWidth: 42 }),
    ...
    h(
      ...
      h(
        ...
        h(TextInput, {
          ...
          onChange: setInput,
          onSubmit: submit,
          placeholder: latestDisambiguation ? "Choose a number or type a clearer task…" : "Type a task or slash command… (/view timeline, /result full)"
        })
      )
    )
  );
