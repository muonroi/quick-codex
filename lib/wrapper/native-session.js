...
function attachObservedPipe(child, streamName, targetStream, observer, { forwardOutput = false } = {}) {
  if (!child[streamName]) {
    return;
  }
...
function attachObservedPty(child, targetStream, observer, { forwardOutput = false } = {}) {
  child.onData((chunk) => {
